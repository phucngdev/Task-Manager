    ...
    <>
      <footer className="py-10 border-t border-border">
        <div className="container mx-auto px-20">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              <a
                ...
                className="text-white text-2xl hover:text-primary hover:scale-125 transition duration-300"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <div className="flex items-center justify-between mt-10 text-white text-sm">
            <div className=""></div>
